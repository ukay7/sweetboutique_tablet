...
type ProductFormState = {
    ...
    base_price: number; image_slot: string; image_url: string; is_featured: boolean; is_active: boolean; sort_order: number;
...
const blankProduct: ProductFormState = { category_id: 0, subcategory_id: null, name: '', short_description: '', description: '', base_price: 0, image_slot: 'sprite-1', image_url: '', is_featured: false, is_active: true, sort_order: 0, occasion_ids: [], style_ids: [], flavor_ids: [], allergen_ids: [], badge_ids: [], variants: [{ name: 'Classic', price: 0, serves: '8–10 guests', serves_min: 8, serves_max: 10, is_active: true }, { name: 'Grand', price: 0, serves: '14–16 guests', serves_min: 14, serves_max: 16, is_active: true }] };
...
export default function AdminPortal({ returnToStore, onCatalogChanged }: Props) {
    ...
    const openProduct = (product?: Product) => {
        ...
        setProductForm(product ? {
            ...
            short_description: product.short_description, description: product.description || '', base_price: Number(product.base_price),
